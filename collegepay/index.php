...
<div class="container">
    ...
    <div class="row">
    	<article class="col-lg-offset-1 col-sm-offset-1 col-lg-8 col-sm-7 col-lg-push-3 col-sm-push-4">
            ...
            <p>Wisdomi Pet Medicine is a state-of-the-art veterinary hospital,   featuring the latest in diagnostic and surgical equipment, and a staff   of seasoned veterinary specialists in the areas of general veterinary   medicine and surgery, oncology, dermatology, orthopedics, radiology,   ultrasound, and much more. We also have a 24-hour emergency clinic in   the event your pet needs urgent medical care after regular business   hours.</p>
         ...
         <div class="clearfix visible-xs visible-lg"></div>
            <div class="row">
                ...
                <form method="post" action="confirm.php">
                 <input type="hidden" value="51960" name="amount" readonly="readonly"/>
